        ...
        t.push(
          (o[e] = new Promise(function(t, r) {
            for (
              ...
              if ("stylesheet" === s.rel && (l === n || l === u)) return t();
            }
            var f = document.getElementsByTagName("style");
            for (c = 0; c < f.length; c++) {
              var s;
              if ((l = (s = f[c]).getAttribute("data-href")) === n || l === u)
                return t();
            }
...
//# sourceMappingURL=runtime~main.77ba21d3.js.map
